...
from ai_fund_lab_v2.position_management_ai.winner_holding_calibration import (  # noqa: E402
    DEFAULT_ACTION_STATS_PATH,
    DEFAULT_COMPARISON_PATH,
    DEFAULT_LONG_FEATURE_PATH,
    DEFAULT_MISMATCH_PATH,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Phase6-I winner-holding calibration validation.")
    ...
    parser.add_argument("--mismatch-path", default=str(DEFAULT_MISMATCH_PATH))
    ...
    result = run_phase6i_winner_holding_calibration(
