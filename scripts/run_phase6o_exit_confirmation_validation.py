...
from ai_fund_lab_v2.position_management_ai.exit_confirmation_validation import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Phase6-O Exit Confirmation validation.")
