...
from ai_fund_lab_v2.candidate_ai import build_full_range_no_write_summary  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Check Candidate feature full-range no-write final gate.")
    ...
    summary = build_full_range_no_write_summary(
