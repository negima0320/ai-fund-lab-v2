...
from ai_fund_lab_v2.candidate_ai import build_full_range_resume_controlled_summary  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run resume-aware controlled Candidate feature chunks.")
