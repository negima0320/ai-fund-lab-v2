    ...
    for position in positions:
        ...
        patched = {
            **position,
            ...
            "prior_unrepresentable_reduce_count": evidence.get("prior_unrepresentable_reduce_count"),
            "soft_deterioration_episode_id": evidence.get("soft_deterioration_episode_id"),
            "soft_deterioration_episode_state": evidence.get("soft_deterioration_episode_state"),
            "episode_start_business_date": evidence.get("episode_start_business_date"),
            "episode_last_deterioration_business_date": evidence.get("episode_last_deterioration_business_date"),
            "episode_persistence_severity": evidence.get("episode_persistence_severity"),
            "episode_deescalation_reason": evidence.get("episode_deescalation_reason"),
            "hard_deterioration_present": evidence.get("hard_deterioration_present"),
            "exit_confirmation_state": evidence.get("exit_confirmation_state"),
            "prior_soft_deterioration_cleared": evidence.get("prior_soft_deterioration_cleared"),
            "zero_lot_reduce_persistence_scope": evidence.get("zero_lot_reduce_persistence_scope"),
