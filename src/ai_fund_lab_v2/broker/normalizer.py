...
def _normalize_positions(
    ...
    return [
        BrokerPositionSnapshot(
            ...
            quantity=decimal_or_zero(_first(item, "quantity", "sQuantity", "sZanKabuSuu", "sOrderOrderSuryou", "sOrderSuryou", "864")),
            available_quantity=decimal_or_zero(_first(item, "available_quantity", "sAvailableQuantity", "sUritukeKanouSuu", "sOrderCurrentSuryou", "861")),
            average_price=decimal_or_zero(_first(item, "average_price", "sAveragePrice", "sBokaTanka", "sHeikinTanka", "855")),
            market_price=decimal_or_zero(_first(item, "market_price", "sMarketPrice", "sGenzaine", "sGenzaichi", "859")),
            market_value=decimal_or_zero(_first(item, "market_value", "sMarketValue", "sHyokaGaku", "sHyoukaGaku", "858")),
            unrealized_pnl=decimal_or_zero(_first(item, "unrealized_pnl", "sUnrealizedPnl", "sHyokaSoneki", "sHyoukaSoneki", "856")),
            raw_clmid=envelope.clmid,
            raw_result_code=envelope.result_code,
            warnings=warnings,
        )
