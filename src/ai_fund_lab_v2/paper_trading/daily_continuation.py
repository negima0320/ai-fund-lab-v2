...
def run_daily_continuation(
    *,
    ...
    operation_run_date: str | None = None,
    ...
    valuation = update_ledger_valuation_from_files(
        ...
        run_date=operation_run_date or run_date,
        expected_valuation_date=expected_valuation_date or (operation_run_date or run_date),
        run_id=run_id,
