...
def capital_allocation_regression_evidence(*, repo: Path, output_root: Path) -> dict[str, Any]:
    ...
    pending_item = PendingOrderItem(
        ...
        target_investment_ratio=planned_item.target_investment_ratio,
        cash_buffer=planned_item.cash_buffer,
        max_exposure=planned_item.max_exposure,
        max_position_weight=planned_item.max_position_weight,
