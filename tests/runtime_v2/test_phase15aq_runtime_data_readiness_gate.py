...
def _candidate_row(symbol: str, feature_date: str) -> dict:
    return {
        ...
        "momentum_1d_vs_5d_delta": -0.03,
        "momentum_5d_vs_20d_delta": -0.05,
        "price_momentum_return_1d": 0.02,
        "price_momentum_return_3d": 0.04,
        "price_momentum_return_10d": 0.07,
        "price_momentum_return_20d": 0.1,
        "price_momentum_return_5d": 0.05,
        "price_momentum_return_60d": 0.2,
        "recent_move_volatility_z_1d": 1.0,
        "recent_move_volatility_z_3d": 1.1547,
