...
def _write_portfolio_policy(tmp_path: Path) -> Path:
    ...
    risk_pacing = {
        ...
        "risk_pacing_reason_codes": ["RISK_PACING_GRADUAL_REDEPLOYMENT"],
        "risk_pacing_evidence_completeness": "PARTIAL",
        ...
        "risk_pacing_component_evidence": {
            ...
            "market_quality_evidence_completeness": "PARTIAL",
    ...
    internal_policy = {
        ...
        "resolved_candidate_capacity": 2,
        "resolved_opportunity_capacity": 2,
        "single_name_weight_cap": 0.25,
        "single_name_weight_cap_source": "fixture#single_name_weight_cap",
        "single_name_weight_cap_authority": {"status": "PASS", "source": "fixture#single_name_weight_cap", "single_name_weight_cap": 0.25, "canonical_owner": "portfolio_policy"},
    ...
    payload = {
        ...
        "deployment_posture": "BALANCED_DEPLOYMENT",
        **risk_pacing,
        "incremental_capital_budget_envelope": portfolio_policy._incremental_capital_budget_envelope(
            business_date="2026-07-15",
            as_of="2026-07-15T00:00:00+00:00",
            market_payload={
                "business_date": "2026-07-15",
                "feature_date": "2026-07-15",
                "market_quality_state": "RECOVERY_CONFIRMATION_INCOMPLETE",
                "market_quality_as_of": "2026-07-15",
                "market_quality_evidence_completeness": "PARTIAL",
            },
